...
(function () {
  ...
  var CARDS = {
    ...
    cta: function (c) {
      return el('app-card c-cta',
        ...
        '<div class="cta-b"><a class="btn" href="' + c.mail + '">' + c.btn + ' <span class="arr">→</span></a>' +
        '<a class="btn ghost" href="https://t.me/yesmcp">Telegram</a></div>');
    }
  };
  ...
  var CTA = { card: { type: 'cta', title: 'Хочете так само у своєму бізнесі?', text: 'Покажемо живий продукт з телефона за 15 хвилин — без слайдів.', btn: 'Покажемо за 15 хвилин', mail: MAIL } };
