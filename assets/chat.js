...
(function () {
  ...
  var SCRIPT = {
    ...
    /* --- shop: repeat purchase for an existing customer --- */
    shop1: {
      steps: [
        { a: 'Ролі такі: я — ваш магазин, ви — ваш ПОСТІЙНИЙ клієнт. У березні ви купили в мене бігові. Сьогодні пишете:' }
      ],
      chips: [{ t: 'Мої бігові ще є? Хочу такі самі, 42', go: 'shop2' }]
    },
    shop2: {
      steps: [
        { a: 'Дивлюсь вашу історію… У березні ви брали WaterGrip City, сірі, 42. Вони є — і є оновлена модель з кращою мембраною:' },
        { card: { type: 'product', title: 'Ваш магазин · Ваша історія', img: '👟', name: 'WaterGrip City 2', price: '₴3 490', vars: ['Сірі', 'Чорні'] } }
      ],
    ...
    shop3: {
      steps: [
        ...
        { a: 'Повторний продаж за хвилину. Без SMS-розсилки, знижки «поверніться» і реклами навздогін — клієнт сам прийшов туди, де ви тепер живете.' },
        { card: { type: 'track', title: 'Замовлення №1204', steps: ['Оплачено', 'Передано в доставку', 'У відділенні'], at: 1 } },
        { a: 'Статус доставки він теж спитає тут — не дзвінком у ваш офіс.' }
      ],
      chips: [
        { t: 'А дай знижку 50% 😏', go: 'shop4' },
        { t: 'Сповісти, коли буде розмір', go: 'notify' },
        { t: 'А як це для експерта?', go: 'exp1' }
      ]
    },
    notify: {
      steps: [
        { u: 'А зимові TrailGrip є? 42-й' },
        { a: 'Зараз 42-го немає — залишились 40 і 44. Сповістити вас, щойно 42-й приїде на склад?' },
        { u: 'Так, сповісти' },
        { sys: '· · · через 5 днів · · ·' },
        { a: '42-й приїхав 👟 Тримаю пару за вами до вечора:' },
        { card: { type: 'product', title: 'Ваш магазин · Очікування', img: '🥾', name: 'TrailGrip Winter', price: '₴4 190', vars: ['42'] } },
        CTA
      ],
      chips: [
        { t: 'А як це для експерта?', go: 'exp1' },
    ...
    svc3: {
      steps: [
        ...
        { a: 'Запис зроблено о 23:40 — коли адміністратор спав. Жодного пропущеного клієнта.' },
        CTA
      ],
      chips: [
    ...
    svcmove: {
      steps: [
        ...
        { card: { type: 'slots', title: 'Наступні дні', slots: ['Нд 12:00', 'Вт 18:30', 'Ср 9:00'], sel: -1 } }
      ],
      chips: [{ t: 'Неділя, 12:00', go: 'svcmove2' }]
    },
    svcmove2: {
      steps: [
        { card: { type: 'confirm', label: 'Масаж · 60 хв', when: 'Нд, 12:00', note: 'Суботнє вікно звільнено — воно вже продається наступному клієнту.' } },
        { a: 'Жодного дзвінка, жодного «передзвоню пізніше». Розклад живе сам.' },
        CTA
      ],
      chips: [
        { t: 'А як це для магазину?', go: 'shop1' },
